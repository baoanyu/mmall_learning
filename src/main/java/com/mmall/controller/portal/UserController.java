...
public class UserController {
    ...
    @RequestMapping(value = "fot_get_question.do", method = RequestMethod.POST)
    public ServerResponse forGetQuestion(String username) {
        return iUserService.selectQuestion(username);
    }

    @RequestMapping(value = "fot_get_check_answer.do", method = RequestMethod.POST)
    public ServerResponse<String> forGetCheckAnswer(String username, String question, String answer) {
        return iUserService.checkAnswer(username, question, answer);
    }

    @RequestMapping(value = "fot_get_rest_password.do", method = RequestMethod.POST)
